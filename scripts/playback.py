#!/usr/bin/env python3
""" 
Original script and description can be found here: 
https://github.com/BR-/aos_replay
This version contains quick fixes for newer versions of python and enet
"""
...
while True:
	...
	if event is None:
		...
		if not cl.spawned and cl.playerid is not None:
			cl.spawned = True
